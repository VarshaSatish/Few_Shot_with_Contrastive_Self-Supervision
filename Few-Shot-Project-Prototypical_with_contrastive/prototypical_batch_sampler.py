...
class PrototypicalBatchSampler(object):
    ...
    def __iter__(self):
        ...
        for it in range(self.iterations):
            ...
            c_idxs = torch.randperm(len(self.classes))[:cpi] # take the last cpi number of items from a randomly permuted batch.
            for i, c in enumerate(self.classes[c_idxs]):
                s = slice(i * spc, (i + 1) * spc)  # takes a batch of samples
            ...
            if(it==0):
               # print('s',s.size())
                ...
                print('sample idx',sample_idxs.shape)
